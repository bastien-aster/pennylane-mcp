...
- Descriptions d'outils enrichies (les auto-générées restent succinctes)
- Tests contre un compte sandbox
- Système de profils pour limiter les outils chargés selon le besoin
...
- Richer tool descriptions (auto-generated ones stay terse)
- Tests against a sandbox account
- Profile system to limit which tools load based on need
