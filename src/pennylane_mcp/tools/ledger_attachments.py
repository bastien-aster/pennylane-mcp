...
@tool(
    ...
    description="List attachments. List attachments > ‼️ > This endpoint is **DEPRECATED** > As soon as you opt in to the new version, or when the sunset phase starts and you haven't explicitly opted out of the old behavior, this endpoint will no longer work. For more details, see our API documentation https://pennylane.readme.io/docs/2026-api-changes-guide for migration instructions. > ℹ️ > This endpoint requires the following scope: `ledger`",
